  ...
  <body>
    ...
    <div class="class-fluid">
        <div class="row d-flex justify-content-center">
            <div class="col-8">
                <form action="./question1.php" method="post" value="resp1">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <label for="question1">Ordem e Progesso</label>
                    </div>
                    <div class="mb-3">
                ...
                <?php
                    if (isset($_POST['question1'])) {
                        if (empty($_POST['question1'])){
                            echo '<div class="alert alert-warning" role="alert">Selecione uma alternativa</div>';
                        }

                        if(!empty($_POST['question1'])){
                            if($_POST['question1'] == 'resp1'){
                                echo '<div class="alert alert-success" role="alert">Voce acertou!</div>';
                            }
                            if($_POST['question1'] != 'resp1'){
                                echo '<div class="alert alert-danger" role="alert">Voce errou!</div>';
                        }
                    }
                }
                ?>
